  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 transition-colors duration-300 dark:bg-black dark:text-white">
      ...
      {route === 'card' ? (
        ...
        <Deferred minHeight={600}>
          <PageHead
            tag={tr("Модели сотрудничества")}
            title={tr("Роль OLAN в проектах партнёров")}
        ...
        <Deferred minHeight={600}>
          <PageHead
            tag={tr("Задачи заказчика")}
            title={tr("С чем к нам приходят")}
        ...
        <Deferred minHeight={600}>
          <PageHead
            tag={tr("Что мы делаем")}
            title={tr("Услуги и направления деятельности")}
        ...
        <Deferred minHeight={600}>
          <PageHead
            tag={tr("Продуктовая линейка")}
            title={tr("Продукты компании")}
