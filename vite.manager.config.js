...
// Кабинет менеджера. Запуск: npm run manager
...
export default defineConfig(({ mode, command }) => {
  ...
  return {
    ...
    server: { host, port: 9091, strictPort: false, allowedHosts: true },
    preview: { host, port: 9091, allowedHosts: true },
