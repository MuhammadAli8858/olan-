...
// Админ-панель. Запуск: npm run admin
...
export default defineConfig(({ mode, command }) => {
  ...
  // префиксу /admin/), поэтому ссылки на собранные файлы
  ...
  return {
    ...
    server: { host, port: 9000, strictPort: false, allowedHosts: true },
    preview: { host, port: 9000, allowedHosts: true },
